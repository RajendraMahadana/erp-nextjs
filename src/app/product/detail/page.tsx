        	...
        	<div className="">
                ...
                <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="d-flex w-100  justify-content-between">
                        <div className="d-flex mt-auto">
                            <h3 className="mb-3">Detail Produk</h3>
                        </div> 
                        ...
                        <div className="d-flex  align-items-center gap-4 justify-content-between">
                            <div className="d-flex flex-column">
                                <span className="text-muted fs-15">Pembelian</span>
                                <span className="fs-14">20</span>
                            </div>
                                        <div className="">
                                            <button type="button" className="btn btn-icon btn-primary btn-wave"> <i className="bi bi-box"></i></button>
                                    </div>
                                </div>
                        </div>
                        <div className="card card-body ">
                        ...
                        <div className="d-flex  align-items-center gap-4  justify-content-between">
                            <div className="d-flex flex-column">
                                <span className="text-muted fs-15">Penjualan</span>
                                <span className="fs-14">10</span>
                            </div>
                                        <div className="">
                                            <button type="button" className="btn btn-icon btn-warning btn-wave"> <i className="bi bi-box"></i></button>
                                    </div>
                                </div>
                        </div>
                ...
                <div className="card card-body">
                    <div className="d-flex gap-4">
                        <div className="w-50">
                            <img src="../assets/images/media/media-49.jpg" className="img-fluid rounded w-100" alt="..."></img>
                        </div>
                        ...
                        <button type="button" className="btn btn-outline-light btn-wave">
                           <i className="bi bi-list"></i>
                                ...
                                <div className="d-flex gap-3 mb-5">
                                    <div className="border rounded justify-content-center align-items-center d-flex flex-column px-4 py-2">
                                        <span>Harga Beli</span>
                                        <span className="fw-semibold fs-15">Rp 3.000.000</span>
                                    </div>
                                    <div className="border rounded justify-content-center align-items-center d-flex flex-column px-4 py-2">
                                        <span>Harga Jual</span>
                                        <span className="fw-semibold fs-15">Rp 3.500.000</span>
                                    </div>
                                </div>

                                <div className="mb-4">
                                    <h5>Deskripsi</h5>
                                    <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga numquam aliquid sint dolores quas eos tempora obcaecati, maxime facere. Quos quae laboriosam veritatis quo, nam placeat recusandae pariatur quod fugit!</span>
                                </div>
                                <div className="d-flex gap-5">

                                    <div className="d-flex align-items-cente gap-3">
                                        <div className="">
                                            <button type="button" className="btn btn-icon btn-info btn-wave"> <i className="bi bi-box"></i></button>
                                    </div>
                                    <div className="d-flex flex-column">
                                ...
                                <div className="d-flex align-items-cente gap-3">
                                    <div className="">
                                        <button type="button" className="btn btn-icon btn-info btn-wave"> <i className="ri-archive-line"></i></button>
                                    </div>
                                    <div className="d-flex flex-column">
                                ...
                                <div className="d-flex align-items-cente gap-3">
                                    <div className="">
                                        <button type="button" className="btn btn-icon btn-info btn-wave"> <i className="bi bi-tags"></i></button>
                                    </div>
                                    <div className="d-flex flex-column">
                            ...
                            <div className="card-body">
                                ...
                                <table id="responsiveDataTable" className="table text-nowrap" style={{ width:"100%" }}>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>15 Juni 2025</td>
                                            <td>	Tagihan Penjualan <br></br> (PI/00002) - Adausaha Hendra</td>
