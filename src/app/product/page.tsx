								...
								<div className="row">
									<div className="col-8">
										<div className="ps-4 pt-4 pe-3 pb-4 pt-0">
											<div className="">
												<p className="mb-2 fs-12 fw-semibold">Produk Stok Tersedia</p>
											</div>
							...
							<div className="card sales-card circle-image2">
								<div className="row">
									<div className="col-8">
										<div className="ps-4 pt-4 pe-3 pb-4 pt-0">
											<div className="">
												<p className="mb-2 fs-12 fw-semibold">Produk Stok Menipis</p>
											</div>
											<div className="pb-0 mt-0">
												<div className="d-flex">
							...
							<div className="card sales-card circle-image3">
								<div className="row">
									<div className="col-8">
										<div className="ps-4 pt-4 pe-3 pb-4 pt-0">
											<div className="">
												<p className="mb-2 fs-12 fw-semibold">Produk Stok Habis</p>
											</div>
											<div className="pb-0 mt-0">
												<div className="d-flex">
							...
							<div className="card sales-card circle-image3">
								<div className="row">
									<div className="col-8">
										<div className="ps-4 pt-4 pe-3 pb-4 pt-0">
											<div className="">
												<p className="mb-2 fs-12 fw-semibold">Total stok</p>
											</div>
											<div className="pb-0 mt-0">
												<div className="d-flex">
                ...
                <div className="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div className="d-flex gap-2 ">
                        ...
                        <button type="button" className="btn btn-teal  btn-wave">
                          ...
                          <Link href="/product/create">Tambah Produk</Link>
                        </button>
                                ...
                                <table id="responsiveDataTable" className="table text-nowrap" style={{ width:"100%" }}>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><Link href={"/product/detail"}>SKU0001</Link></td>
                                            <td>Laptop</td>
                                            <td>Asus ROG</td>
                                            <td>Elektronik</td>
                                            <td>Gudang 1</td>
