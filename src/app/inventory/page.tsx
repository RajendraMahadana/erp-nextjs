                    ...
                    <div className="card card-body">
                        ...
                        <div className="d-flex w-100 justify-content-between gap-4">
                            <div className="d-flex flex-column">
                                            ...
                                            <div className="w-100 border rounded border-2">
                                                <img src="../assets/images/media/unnamed.png" className="img-fluid w-100 h-75 rounded" alt="..."></img>
                                            </div>
                                            
                                            <div>
                                                <h6>Gudang Elektronik</h6>
                                            </div>
                                        </div>
						<div className="d-flex flex-column">
        ...
        <footer className="footer mt-auto py-3 bg-white text-center">
            <div className="container">
                <span> Copyright © <span id="year"></span> <a
                        href="javascript:void(2);" className="text-primary">Nowa</a>.
                    Designed with <span className="bi bi-heart-fill text-danger"></span> by <a href="javascript:void(2);">
