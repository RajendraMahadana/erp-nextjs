        ...
        <>
            <div className="">
                ...
                <div className="d-flex align-items-center mb-3 justify-content-between">
                        <div>
                            <h3 className="mb-3">Vendor Data</h3>
                        </div>               
                </div>

                <div className="d-flex gap-2 table-responsive">
								...
								<div className="row">
									<div className="col-8">
										<div className="ps-4 pt-4 pe-3 pb-4 pt-0">
											<div className="">
												<p className="mb-2 fs-12 fw-semibold">Anda Hutang</p>
											</div>
									...
									<div className="col-4">
										<div className="circle-icon widget bg-primary text-center align-self-center  overflow-hidden ">
											<i className="fe fe-package  fs-20 lh-lg text-fixed-white"></i>
										</div>
									</div>
								</div>
							</div>
							...
							<div className="card sales-card circle-image2">
								<div className="row">
									<div className="col-8">
										<div className="ps-4 pt-4 pe-3 pb-4 pt-0">
											<div className="">
												<p className="mb-2 fs-12 fw-semibold">Mereka Hutang</p>
											</div>
											<div className="pb-0 mt-0">
												<div className="d-flex">
													<h4 className="fs-26 fw-semibold mb-2">19</h4>
												</div>
											</div>
										</div>
									</div>
									<div className="col-4">
										<div className="circle-icon widget bg-warning text-center align-self-center  overflow-hidden ">
											<i className="fe fe-package fs-20 lh-lg text-fixed-white"></i>
										</div>
									</div>
								</div>
							...
							<div className="card sales-card circle-image3">
								<div className="row">
									<div className="col-8">
										<div className="ps-4 pt-4 pe-3 pb-4 pt-0">
											<div className="">
												<p className="mb-2 fs-12 fw-semibold">Sudah dibayar</p>
											</div>
											<div className="pb-0 mt-0">
												<div className="d-flex">
													<h4 className="fs-26 fw-semibold mb-2">5</h4>
												</div>
											</div>
										</div>
									</div>
									<div className="col-4">
										<div className="circle-icon widget bg-danger text-center align-self-center  overflow-hidden">
											<i className="fe fe-package fs-20 lh-lg text-fixed-white"></i>
										</div>
									</div>
								</div>
							...
							<div className="card sales-card circle-image3">
								<div className="row">
									<div className="col-8">
										<div className="ps-4 pt-4 pe-3 pb-4 pt-0">
											<div className="">
												<p className="mb-2 fs-12 fw-semibold">Hutang jatuh tempo</p>
											</div>
											<div className="pb-0 mt-0">
												<div className="d-flex">
													<h4 className="fs-26 fw-semibold mb-2">99</h4>
												</div>
											</div>
										</div>
									</div>
									<div className="col-4">
										<div className="circle-icon widget bg-info text-center align-self-center  overflow-hidden ">
											<i className="fe fe-package fs-20 lh-lg text-fixed-white"></i>
										</div>
									</div>
								</div>
							...
							<div className="card sales-card circle-image3">
								<div className="row">
									<div className="col-8">
										<div className="ps-4 pt-4 pe-3 pb-4 pt-0">
											<div className="">
												<p className="mb-2 fs-12 fw-semibold">Tagihan mereka</p>
											</div>
											<div className="pb-0 mt-0">
												<div className="d-flex">
													<h4 className="fs-26 fw-semibold mb-2">99</h4>
                ...
                <div className="d-flex justify-content-end align-items-center mb-3">
                    ...
                    <div className="d-flex gap-2 ">
                        ...
                        <button type="button" className="btn btn-teal  btn-wave">
                          ...
                          <a href="create-invoice.html">Tambah Vendor</a>
                        </button>
                    ...
                    <div className="d-flex gap-2">
                        ...
                        <button type="button" className="btn btn-outline-light btn-wave">
                         ...
                         <div className="btn-group">
                                                ...
                                                <ul className="dropdown-menu">
                                                    <li><a className="dropdown-item" href="javascript:void(0);">Aktif</a></li>
                                                    <li><a className="dropdown-item" href="javascript:void(0);">non-aktif</a></li>
                                ...
                                <table id="responsiveDataTable" className="table text-nowrap" style={{ width:"100%" }}>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>0</td>
                                            <td>
                                                <span className="badge bg-primary-transparent">Aktif</span> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><input className="form-check-input" type="checkbox" id="checkboxNoLabel1" value="" aria-label="..."></input></th>
                                            ...
                                            <td>PCS</td> 
                                            <td>
                                                <span className="badge bg-danger-transparent">non-aktif</span> 
                                            </td>
                                        </tr>
                                        <tr>
                                            <th scope="row"><input className="form-check-input" type="checkbox" id="checkboxNoLabel1" value="" aria-label="..."></input></th>
