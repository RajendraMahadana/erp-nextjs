        ...
        <>
            <div className="main-content">
                ...
                <div className="d-flex align-items-center mb-3 justify-content-between">
                    <div>
                        <h3 className="mb-3">Sales Order</h3>
                    </div>
                    <div className="d-flex gap-2 ">
                        ...
                        <button type="button" className="btn btn-info btn-wave">
                            ...
                            <Link href={"/sales/orders/create"}><span>Tambah Sales Order</span></Link>
                        </button>
                    </div>
                </div>
                ...
                <div className="d-flex justify-content-between align-items-center mb-3">
                    <div className="gap-2 d-flex">
                        ...
                        <button type="button" className="btn btn-outline-light btn-wave">Draft</button>
                        <button type="button" className="btn btn-outline-light btn-wave">Dikonfirmasi</button>
                        <button type="button" className="btn btn-outline-light btn-wave">Selesai</button>
                    </div>
                    <div className="d-flex gap-2">
                ...
                <div className="card-body">
                    <div className="table-responsive">
                        <table id="salesOrderTable" className="table text-nowrap text-center" style={{ width: "100%" }}>
                            <thead>
                                <tr>
                                    <th></th>
                                    <th>No. Order</th>
                            ...
                            <tbody>
                                <tr>
                                    <th scope="col"><input className="form-check-input" type="checkbox" id="checkboxNoLabel1" value=""
                                        aria-label="..."></input></th>
                                    <td><Link href={"/sales/orders/detail"}>SO/2025/0001</Link></td>
                                    <td>12 Juni 2025</td>
                                    <td>PT Jaya Abadi</td>
                                    <td>Rp 15.000.000</td>
                                    <td><span className="badge bg-success-transparent">Selesai</span></td>
                                    <td>
                                        ...
                                        <div className="btn-group">
                                            ...
                                            <ul className="dropdown-menu">
                                                <li><a className="dropdown-item" href="detail_sales_order.html">Details</a></li>
                                ...
                                <tr>
                                    <th scope="col"><input className="form-check-input" type="checkbox" id="checkboxNoLabel2" value=""
                                        aria-label="..."></input></th>
                                    <td>SO/2025/0002</td>
                                    <td>13 Juni 2025</td>
                                    <td>CV. Maju Jaya</td>
                                    <td>Rp 8.250.000</td>
                                    <td><span className="badge bg-info-transparent">Dikonfirmasi</span></td>
                                    <td>
                                      <div className="d-flex gap-2 justify-content-center">
                                ...
                                <tr>
                                    <th scope="col"><input className="form-check-input" type="checkbox" id="checkboxNoLabel3" value=""
                                        aria-label="..."></input></th>
                                    <td>SO/2025/0003</td>
                                    <td>14 Juni 2025</td>
                                    <td>PT Sejahtera</td>
                                    <td>Rp 21.700.000</td>
                                    <td><span className="badge bg-secondary-transparent">Draft</span></td>
                                    <td>
                                      <div className="d-flex gap-2 justify-content-center">
