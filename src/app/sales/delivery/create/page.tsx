            ...
            <div className="">
                ...
                <div className="main-container container-fluid">
                    ...
                    <div className="d-flex align-items-center mb-3 justify-content-between">
                        <div>
                            <h3 className="mb-3">Form Delivery</h3>
                        </div>
                        ...
                        <div className="d-flex gap-2 ">
                            ...
                            <button type="button" className="btn btn-teal d-flex gap-1 align-items-center btn-wave">
                                ...
                                <Link href="/sales/delivery">Kembali</Link>
                            </button>
                            ...
                            <div className="col-xl-12">
                                <div className="card custom-card">
                                    ...
                                    <div className="card-body">
                                        <div className="row gy-4">
                                            ...
                                            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                                <label htmlFor="no-surat" className="form-label">No. Surat Jalan</label>
                                                <input type="text" className="form-control" id="no-surat" placeholder="SJ-001/2025"></input>
                                            </div>

                                            <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                                <label htmlFor="tanggal-surat" className="form-label">Tanggal</label>
                                                <input type="date" className="form-control" id="tanggal-surat"></input>
                                            </div>

                                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                                <label htmlFor="pengirim" className="form-label">Nama Pengirim</label>
                                                <input type="text" className="form-control" id="pengirim" placeholder="PT. Sumber Jaya"></input>
                                            </div>

                                            <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                                <label htmlFor="penerima" className="form-label">Nama Penerima</label>
                                                <input type="text" className="form-control" id="penerima" placeholder="PT. Maju Terus"></input>
                                            </div>

                                            <div className="col-xl-12">
                                                <label htmlFor="alamat" className="form-label">Alamat Penerima</label>
                                                <textarea className="form-control" id="alamat" rows={2} placeholder="Jl. Merdeka No. 123, Jakarta"></textarea>
                                            </div>
                                                ...
                                                <table className="table table-bordered">
                                                    <thead style={{ backgroundColor: "#2c3e50", color: "white", textAlign: "center" }}>
                                                        <tr>
                                                            ...
                                                            <th>Deskripsi <span className="text-danger">*</span></th>
                                                    ...
                                                    <tbody id="barangTable">
                                                        <tr>
                                                            ...
                                                            <td><input type="text" className="form-control" placeholder="Deskripsi Produk"></input></td>
                                                            <td><input type="number" className="form-control" placeholder="Isi kuantitas"></input></td>
                                                            <td><input type="text" className="form-control" placeholder="Unit"></input></td>
                                            ...
                                            <div className="col-xl-12">
                                                ...
                                                <textarea className="form-control" id="catatan" rows={2} placeholder="Catatan tambahan..."></textarea>
                                            </div>
                                    ...
                                    <div className="card-footer text-end">
                                        <div className="card-footer text-end">
                                            <button className="btn btn-primary">Simpan Surat Jalan</button>
                                        </div>
                                    </div>
                                </div>
                                {/* <!-- /Container --> */}
