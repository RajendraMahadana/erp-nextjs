       ...
       <div className="">
            ...
            <div className="main-container container-fluid">
                ...
                <div className="d-flex align-items-center mb-3 justify-content-between">
                    <div>
                        <h3 className="mb-3">Sales Summary</h3>
                    </div>
                    ...
                    <div className="container">
                        ...
                        <div className="row row-sm">
                            ...
                            <div className="col-xl-3 col-lg-6 col-md-6 col-xm-12">
                                <div className="card sales-card bg-white shadow-sm">
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="ps-4 pt-4 pe-3 pb-4 pt-0">
                                                <p className="mb-2 fs-12 fw-semibold">Stok Barang</p>
                                        ...
                                        <div className="col-4 d-flex align-items-center justify-content-center">
                                            <div className="rounded-circle bg-light p-3">
                                                <i className="fas fa-boxes fs-20 text-dark"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {/* <!-- Card Invoice Penjualan --> */}
                            <div className="col-xl-3 col-lg-6 col-md-6 col-xm-12">
                                <div className="card sales-card bg-white shadow-sm">
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="ps-4 pt-4 pe-3 pb-4 pt-0">
                                                <p className="mb-2 fs-12 fw-semibold">Invoice Penjualan</p>
                                        ...
                                        <div className="col-4 d-flex align-items-center justify-content-center">
                                            <div className="rounded-circle bg-light p-3">
                                                <i className="fas fa-file-invoice-dollar fs-20 text-dark"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-xl-3 col-lg-6 col-md-6 col-xm-12">
                                <div className="card sales-card bg-white shadow-sm">
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="ps-4 pt-4 pe-3 pb-4 pt-0">
                                                <p className="mb-2 fs-12 fw-semibold">Barang Terjual</p>
                                        ...
                                        <div className="col-4 d-flex align-items-center justify-content-center">
                                            <div className="rounded-circle bg-light p-3">
                                                <i className="fas fa-cash-register fs-20 text-dark"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-xl-3 col-lg-6 col-md-6 col-xm-12">
                                <div className="card sales-card bg-white shadow-sm">
                                    <div className="row">
                                        <div className="col-8">
                                            <div className="ps-4 pt-4 pe-3 pb-4 pt-0">
                                                <p className="mb-2 fs-12 fw-semibold">Partners</p>
                                                <h4 className="fs-26 fw-semibold mb-2">5,74.12</h4>
                                                <p className="mb-0 fs-12 text-muted">
                                                    Minggu lalu
                                                    <i className="fas fa-arrow-circle-down mx-2 text-danger"></i>
                                        ...
                                        <div className="col-4 d-flex align-items-center justify-content-center">
                                            <div className="rounded-circle bg-light p-3">
                                                <i className="fas fa-handshake fs-20 text-dark"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table className="table text-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Invoice Penjualan</th>
                        ...
                        <footer className="footer mt-auto py-3 bg-white text-center">
                            <div className="container">
                                <span> Copyright © <span id="year"></span> <a href="javascript:void(2);"
                                    ...
                                    <div className="tabs-menu p-3">
                                        ...
                                        <ul className="nav panel-tabs">
                                            ...
                                            <li className=""><a href="#side2" data-bs-toggle="tab"><svg
                                                        ...
                                                        enable-background="new 0 0 24 24" className="side-menu__icon"
                                                        height="24" viewBox="0 0 24 24" width="24">
                                                        <g>
                                                            <path d="M0,0h24v24H0V0z" fill="none" />
                                                        </g>
                                            ...
                                            <li className=""><a href="#side3" data-bs-toggle="tab"><svg
                                                        ...
                                                        className="side-menu__icon" height="24" version="1.1" width="24"
                                                        viewBox="0 0 24 24">
                                                        <path
