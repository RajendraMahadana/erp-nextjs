        ...
        <>
            <div className="">
                ...
                <div className="d-flex align-items-center mb-3 justify-content-between">
                        <div>
                            <h3 className="mb-3">Cash & Bank</h3>
                        </div>
                    ...
                    <div className="d-flex gap-2 ">
                        ...
                        <button type="button" className="btn btn-info btn-wave">
                          ...
                          <a href="create-invoice.html"><span>Tambah Cash & Bank</span></a>
                        </button>
                    ...
                    <div className="card custom-card">
                        <div className="card-body">
                              <div className="d-flex justify-content-between mb-2">
                                ...
                                <div>
                                    <button type="button" className="btn btn-primary btn-wave d-flex gap-2 align-items-center">
                                        <i className="bi bi-credit-card"></i>
                                         <Link href="/balance/manage-account"><span>Atur Akun</span></Link>
                                    </button>
                                </div>
                              </div>
